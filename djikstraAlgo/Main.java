...
public class Main {
    ...
    static void printIntermediate(int shortestPath[], int V)
    {
        int a = -1;
        System.out.println();
    ...
    static void printDistance(int shortestPath[], int source, int V)
    {
    ...
    static int currentVertex(int shortestPath[], Boolean permVertex[], int v)
    {
    ...
    static void Dijkstra(int weight[][], int source, int V)
    {
